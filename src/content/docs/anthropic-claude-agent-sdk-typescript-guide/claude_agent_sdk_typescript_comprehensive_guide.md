...
Latest: 0.2.133 | Updated: May 8, 2026
...
|---------|------|----------|
| 0.2.133 | May 8, 2026 | Patch releases (0.2.129–0.2.133); dependency updates; version confirmed against npm `@anthropic-ai/claude-agent-sdk 0.2.133` (latest, 2026-05-08, `.routine-envs/check-0508-node`). `query` runtime export PASS. |
