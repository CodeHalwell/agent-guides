...
## What's new in v0.2.138 (May 2026)
...
|------|-------------------------------|--------------------|----------|
| 2026-05-09 | @anthropic-ai/claude-agent-sdk 0.2.138 | Version bumped 0.2.128 → 0.2.138 (ten patch releases 0.2.129–0.2.138); "What's new" updated documenting newly stable session management exports (`InMemorySessionStore`, `forkSession`, `deleteSession`, `listSessions`, `getSessionInfo`, `getSessionMessages`, etc.), `DirectConnectTransport`, `createSdkMcpServer`, and new constants. Revision history entry added. All exports verified against npm `@anthropic-ai/claude-agent-sdk@0.2.138` (2026-05-09, `.routine-envs/check-0509-node`). | Claude routine |
