...
description: "The @tool decorator, FunctionTool class, approval gates, explicit schemas, runtime context, invocation limits, and result parsers. All verified against agent-framework-core 1.3.0."
