...
description: "OpenTelemetry traces, metrics, and logs emitted by agent-framework-core 1.3.0. Enable instrumentation, ship to Azure Monitor / OTLP / console, or the VS Code AI Toolkit."
...
Verified against `agent-framework-core==1.3.0` (`agent_framework.observability`).
