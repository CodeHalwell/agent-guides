...
description: "Sequential, Concurrent, Handoff, GroupChat and Magentic-One builders — all from agent-framework-orchestrations 1.0.0b260507. Real signatures and runnable examples."
...
All signatures below are verified against `agent-framework-orchestrations==1.0.0b260507`.
