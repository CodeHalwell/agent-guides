---
title: "Amazon Bedrock Agents: Complete Technical Documentation"
description: "> Strands SDK Version: 1.36.0 (April 17, 2026) — previously ~1.0 (November 2025) > TypeScript SDK: strands-agents-ts 1.0.0-rc.3"
...
|----------|---------|----------|-------|
| **[bedrock_agents_comprehensive_guide.md](./bedrock_agents_comprehensive_guide/)** | Core concepts, architecture, and fundamentals | All developers | Beginner → Intermediate |
| **[bedrock_agents_diagrams.md](./bedrock_agents_diagrams/)** | Visual architecture patterns and flow diagrams | Architects, DevOps | All levels |
| **[bedrock_agents_production_guide.md](./bedrock_agents_production_guide/)** | Deployment, operations, security, monitoring | DevOps, Platform teams | Advanced |
| **[bedrock_agents_recipes.md](./bedrock_agents_recipes/)** | Practical implementations and use cases | Developers | Intermediate → Advanced |
| **[bedrock_agentcore_comprehensive_guide.md](./bedrock_agentcore_comprehensive_guide/)** | AgentCore serverless runtime and framework support | All developers | Intermediate |
| **[bedrock_strands_sdk_guide.md](./bedrock_strands_sdk_guide/)** | Strands lightweight agent framework and collaboration patterns | Developers | Intermediate → Advanced |
| **[bedrock_a2a_protocol_guide.md](./bedrock_a2a_protocol_guide/)** | Agent-to-Agent protocol for cross-framework communication | Developers, Architects | Advanced |
| **[bedrock_agents_advanced_multi_agent_python.md](./bedrock_agents_advanced_multi_agent_python/)** | Advanced multi-agent patterns and hierarchies | Developers | Advanced |
