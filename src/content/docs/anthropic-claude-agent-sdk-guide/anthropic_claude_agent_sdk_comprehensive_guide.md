...
Latest: 0.1.77 | Updated: May 8, 2026
...
|---------|------|----------|
| 0.1.77 | May 8, 2026 | Patch releases (0.1.74–0.1.77); stability improvements. Version confirmed against installed `claude-agent-sdk 0.1.77` (`.routine-envs/check-0508-claude`); `query`, `ClaudeSDKClient`, `ClaudeAgentOptions`, `PermissionMode`, `McpServerConfig`, `TextBlock`, `AssistantMessage`, `UserMessage`, `ResultMessage`, `StreamEvent`, `RateLimitEvent` imports verified with `-W error::DeprecationWarning` — all PASS. |
